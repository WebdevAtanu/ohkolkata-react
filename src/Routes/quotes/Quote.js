			...
			<div className="row g-2">
				<div className="col-md-4">
					<div className="container quotes">
						...
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>Tahir Shah</h5>
					</div>
				</div>
				<div className="col-md-4">
					<div className="container quotes">
						...
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>V.S Naipul</h5>
					</div>
				</div>
				<div className="col-md-4">
					<div className="container quotes">
						...
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>Vir Sanghvi</h5>
					</div>
				</div>
				<div className="col-md-4">
					<div className="container quotes">
						<p><q>Calcutta is like another world. People, there are very special and grateful.</q></p>
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>Penelope Cruz</h5>
					</div>
				</div>
				<div className="col-md-4">
					<div className="container quotes">
						<p><q>Kolkata always opens its heart to me and I am a sucker for love.</q></p>
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>Vidya Balan</h5>
					</div>
				</div>
				<div className="col-md-4">
					<div className="container quotes">
						...
						<h5 className="text-end mt-4 text-light"><img src="image/quote/man1.jpg" alt=""/>Carlos Ruiz Zafon</h5>
					</div>
				</div>
			</div>
		</div>
